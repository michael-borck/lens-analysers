...
| Candidate | Ingests | Example signals | Distinct because |
|---|---|---|---|
| **spreadsheet-analyser** | `.xlsx` / `.ods` **as formula logic** | formula complexity, cell-dependency graph, error patterns, named ranges, model structure | `records-analyser` profiles the *data values*; this reads the spreadsheet's *reasoning*. Gap for business/accounting/finance modelling. |
