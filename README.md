...
| [document-analyser](https://github.com/michael-borck/document-analyser) | 0.5.0 | PDF, DOCX, PPTX, TXT, MD — text + readability | `.pdf`, `.docx`, `.pptx`, `.txt`, `.md`, `.qmd`, `.rst` | auto | [PyPI](https://pypi.org/project/document-analyser/) · [repo](https://github.com/michael-borck/document-analyser) |
