...
| [document-analyser](https://github.com/michael-borck/document-analyser) | 0.7.0 | PDF, DOCX, PPTX, TXT, MD — text, readability, .pptx slide-design | `.pdf`, `.docx`, `.pptx`, `.txt`, `.md`, `.qmd`, `.rst` | auto | [PyPI](https://pypi.org/project/document-analyser/) · [repo](https://github.com/michael-borck/document-analyser) |
...
| [video-analyser](https://github.com/michael-borck/video-analyser) | 0.10.0 | video — frames, scenes, transcript + visual quality | `.mp4`, `.mov`, `.avi`, `.webm`, `.mkv` | auto | [PyPI](https://pypi.org/project/video-analyser/) · [repo](https://github.com/michael-borck/video-analyser) |
...
| [conversation-analyser](https://github.com/michael-borck/conversation-analyser) | 0.3.1 | human-AI conversations — engagement + critical-thinking | — | explicit | [PyPI](https://pypi.org/project/conversation-analyser/) · [repo](https://github.com/michael-borck/conversation-analyser) |
