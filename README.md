...
| [cite-sight](https://github.com/michael-borck/cite-sight) | citations & references — verify (Crossref/OpenAlex), DOI, format, cross-refs | — | explicit | [repo](https://github.com/michael-borck/cite-sight) |
